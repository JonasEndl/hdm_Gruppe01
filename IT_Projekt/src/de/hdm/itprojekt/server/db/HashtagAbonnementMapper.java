...
public class HashtagAbonnementMapper {
	 ...
	 * 
	 * @return Ein Vektor mit HashtagAbonnement-Objekten, die sämtliche HashtagAbonnements
	...
	/**
	 * Einfügen eines <code>HashtagAbonnement</code>-Objekts in die Datenbank. Dabei
	...
	public HashtagAbonnement insert(HashtagAbonnement ha) {
		 ...
		 * Objekte übergeben werden, wäre die Anpassung des HashtagAbonnement-Objekts
		 * auch ohne diese explizite Rückgabe außerhalb dieser Methode sichtbar.
		 * Die explizite Rückgabe von ha ist eher ein Stilmittel, um zu
	...
	public HashtagAbonnement update(HashtagAbonnement ha) {
		...
		// Um Analogie zu insert(HashtagAbonnement ha) zu wahren, geben wir ha zurück
		return ha;
	}

	/**
	 * Löschen der Daten eines <code>HashtagAbonnement</code>-Objekts aus der Datenbank.
	 * 
	 * @param ha
